...
print(sort(colSums(!is.na(diffname$sig.test))))
```
...
print(sort(colSums(!is.na(gender$sig.test))))
```
...
print(sort(colSums(!is.na(celltype$sig.test))))
```
...
print(sort(colSums(!is.na(culturecondition$sig.test))))
```
