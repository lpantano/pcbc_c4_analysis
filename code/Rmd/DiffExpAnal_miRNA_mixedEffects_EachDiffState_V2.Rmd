...
CODE <- Folder('../../data/DiffExpAnal_miRNA_mixedEffects_EachDiffState_V2.Rmd',name = 'Differential Expression Analysis miRNA Mixed Effects EachDiffState',parentId = parentId)
CODE <- synStore(CODE)
      
# Store logFC
write.table(logFC,file='../../data/DiffExpAnal_miRNA_mixedEffects_EachDiffState_logFC.tsv',sep='\t',row.names=F,quote=F)
FC_OBJ <- File('../../data/DiffExpAnal_miRNA_mixedEffects_EachDiffState_logFC.tsv',name = 'logFC',parentId = CODE$properties$id)
...
PVAL_OBJ <- File('../../data/DiffExpAnal_miRNA_mixedEffects_EachDiffState_adjPval.tsv',name = 'Adjusted Pvalue',parentId = CODE$properties$id)
...
SIG.SETS_OBJ <- File('../../data/DiffExpAnal_miRNA_mixedEffects_EachDiffState_diffGenes.tsv',name = 'Differentily Expressed miRNA comparison list',parentId = CODE$properties$id)
