...
all_info = lapply(as.character(levels(.states_lvs)), function(this_state){
  ...
  pheatmap(.ma[.ma_hc$order ,.states_lvs], show_rownames = FALSE, cluster_cols = FALSE, cluster_rows = FALSE,annotation_row = as.data.frame(.toy_red[,.toy_hc$order]), annotation_colors = .ann_colors, scale = 'row', annotation_legend = FALSE)
