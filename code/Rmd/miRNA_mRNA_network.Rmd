...
meth_tab = format_table(meth_fc, meth_pval, FC=0.5, PVAL=0.05)
mrna_tab = format_table(mrna_logfc, mrna_pval, map=TRUE)
...
c3_res = merge(mrna_mirna_res, meth_mirna_res, by ='mirna')
```
