...
preAdjustedSigCovars$plots[[1]]$plotData + theme(axis.text.x=element_text(size=10))
...
postAdjustedSigCovars$plots[[1]]$plotData + theme(axis.text.x=element_text(size=10))
```
...
resAdjustedSigCovars = runPCAandPlotCorrelations(t(result.lm$residuals), DM$design, 'residual',isKeyPlot=TRUE, MAX_FDR=1)

resAdjustedSigCovars$plots[[2]]$plotData
```
