---
title: "Covariate Analysis for miRNA data with mixed effect modeling performed at indivudal differentiation stages"
...
```{r synapsestore, echo=FALSE, include=FALSE, eval=FALSE, cache=FALSE}
parentId = "syn4595584"
...
STORED.FILES = lapply(COVARIATES[! names(COVARIATES) %in% c('MESOLATE')], storeFilesInSynapse, PROCESSED_COUNTS, VOOM.GENE.EXPRESSION.POSTADJUSTED, CODE)
